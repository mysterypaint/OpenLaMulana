    ...
    public class MidiProcessor
    {
        ...
        public NAudio.Midi.MidiEventCollection Process()
        {
            ...
            for (var i = 0; i < 16; i++)
            {
                ...
                mid.AddEvent(new NAudio.Midi.ControlChangeEvent(0, i + 1, (NAudio.Midi.MidiController)OpenLaMulana.Audio.Midi.MidiController.NRPN_MSB, 120), 0);//99
                mid.AddEvent(new NAudio.Midi.ControlChangeEvent(0, i + 1, (NAudio.Midi.MidiController)OpenLaMulana.Audio.Midi.MidiController.NRPN_LSB, 38), 0);//98
                mid.AddEvent(new NAudio.Midi.ControlChangeEvent(0, i + 1, (NAudio.Midi.MidiController)OpenLaMulana.Audio.Midi.MidiController.LSBGenerator38, 127), 0);//38
                mid.AddEvent(new NAudio.Midi.ControlChangeEvent(0, i + 1, (NAudio.Midi.MidiController)OpenLaMulana.Audio.Midi.MidiController.MSGgenerator38, 110), 0);//6
