...
namespace OpenLaMulana.Entities.WorldEntities
{
    internal class GenericGlobalWorldEntity : IGlobalWorldEntity
    {
        ...
        public GenericGlobalWorldEntity(int x, int y, int op1, int op2, int op3, int op4, bool spawnIsGlobal, View destView) : base(x, y, op1, op2, op3, op4, spawnIsGlobal, destView)
        {
