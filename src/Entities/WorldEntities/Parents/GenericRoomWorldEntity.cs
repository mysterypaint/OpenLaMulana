...
namespace OpenLaMulana.Entities.WorldEntities
{
    internal class GenericRoomWorldEntity : IRoomWorldEntity
    {
        ...
        public GenericRoomWorldEntity(int x, int y, int op1, int op2, int op3, int op4, bool spawnIsGlobal, View destView, List<ObjectStartFlag> startFlags, bool isHardModeChange) : this(x, y, op1, op2, op3, op4, spawnIsGlobal, destView, startFlags)
        {
            // Hard mode entity
            _tex = Global.TextureManager.GetTexture(Global.Textures.DEBUG_ENTITY_TEMPLATE);
