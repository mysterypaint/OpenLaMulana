...
namespace OpenLaMulana.Entities.WorldEntities
{
    internal class GuardianViy : IGlobalWorldEntity
    {
        ...
        public GuardianViy(int x, int y, int op1, int op2, int op3, int op4, View destView) : base(x, y, op1, op2, op3, op4, destView)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                _tentacles[i] = (GuardianViyTentacle)InstanceCreatePersistent(new GuardianViyTentacle(x, y, -1, -1, -1, -1, null));
            ...
            _eye = (GuardianViyEye)InstanceCreatePersistent(new GuardianViyEye(x, y, -1, -1, -1, -1, null));
