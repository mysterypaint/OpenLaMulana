...
namespace OpenLaMulana.Entities.WorldEntities
{
    internal class GuardianPalenque : IGlobalWorldEntity
    {
        ...
        public GuardianPalenque(int x, int y, int op1, int op2, int op3, int op4, View destView) : base(x, y, op1, op2, op3, op4, destView)
        {
            ...
            _upperBody = (GenericGlobalWorldEntity)InstanceCreatePersistent(new GenericGlobalWorldEntity((int)Position.X, (int)Position.Y, 0, 0, 0, 0, null));
            ...
            _lowerBody = (GenericGlobalWorldEntity)InstanceCreatePersistent(new GenericGlobalWorldEntity((int)Position.X, (int)Position.Y, 0, 0, 0, 0, null));
