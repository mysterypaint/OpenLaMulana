...
namespace OpenLaMulana.System
{
    internal partial class Menu
    {
        ...
        public Menu()
        {
            ...
            _menuPages[(int)OptionsMenuPages.CONFIGURE_KEYBOARD].MenuOptions.Add(new MenuOption("Open Rom Window", MenuTypes.INPUT_KB, null, OptionsMenuPages.NOTHING, InputManager.ConfigKeys[(int)Global.ControllerTypes.Keyboard, (int)Global.ControllerKeys.MENU_OPEN_MSX_SOFTWARE_SELECTION], new int[] { (int)Global.ControllerKeys.MENU_OPEN_MSX_SOFTWARE_SELECTION }, new string[] { InputManager.ConfigKeys[(int)Global.ControllerTypes.Keyboard, (int)Global.ControllerKeys.MENU_OPEN_MSX_SOFTWARE_SELECTION].ToString() }));
